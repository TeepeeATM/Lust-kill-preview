  ...
  return <main className="product-page">
    ...
    <div className="product-info">
      ...
      <div className="purchase-panel">
        ...
        <button className="primary-button" type="button" onClick={()=>{add({slug:product.slug,name:product.name,size,color});setAdded(true)}}>{added?`${color.toUpperCase()} / ${size} ADDED ✓`:"ADD TO BAG"}</button>
        <p className="microcopy">Selected: {color} / Size {size}. Confirm both options before adding to your bag.</p>
      </div>
