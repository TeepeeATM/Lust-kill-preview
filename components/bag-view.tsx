...
export function BagView(){
  ...
  if(items.length===0)return <div className="empty-state"><h1>YOUR BAG IS EMPTY.</h1><p>Drop 001 is waiting.</p><Link className="primary-button inline" href="/shop">VIEW CATALOG</Link></div>;
